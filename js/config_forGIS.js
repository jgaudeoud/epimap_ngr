	...
	var globalParameters = {
			...
			data : {
				...
				epiDataset : {
					...
					source : "data/ner_malaria18_epidatatest.csv",
			...
			analysis : {
				...
				rates : {
	                analysis_1 : {
	                    config : {
	                        name            :   "Consultations par OPD",
	                        abbreviation    :   "WIR",
	                        fieldRate       :   "MOH_M_CASES",
	                        fieldAbsolute   :   "MOH_M_CASES_c",
	                        otherName       :   "Weekly Incidence Rate",
	                        printName       :   "Weekly Incidence Rate (x 10000)"
	                    },
	                    classes : {
	                        class1_less     :   {value : 5,             color : "rgb(255,255,212)"},
	                        class2_between  :   {value : [5, 10],       color : "rgb(254,217,142)"},
	                        class3_between  :   {value : [10, 50],      color : "rgb(254,153,41)"},
	                        class4_between  :   {value : [50, 150],     color : "rgb(217,95,14)"},
	                        class5_more     :   {value : 150,           color : "rgb(153,52,4)"}                   
	                    }
	                },
	                analysis_2 : {
	                    config : {
	                        name            :   "Nb de morts attribués à Malaria par IPD",
	                        abbreviation    :   "CIR",
	                        fieldRate       :   "MOH_M_CASES",
	                        fieldAbsolute   :   "MOH_M_CASES_c",
	                    ...
	                    classes : {
	                        class1_less     :   {value : 7,             color : "rgb(255,255,212)"},
	                        class2_between  :   {value : [7, 10],       color : "rgb(254,217,142)"},
	                        class3_between  :   {value : [10, 50],      color : "rgb(254,153,41)"},
	                        class4_between  :   {value : [50, 300],     color : "rgb(217,95,14)"},
	                        class6_more     :   {value : 300,           color : "rgb(153,52,4)"}
	                    }
	                }					
				},
				...
				geoSources : {
					polygons : {
		                ...
		                source  : "data/ner_lvl1_hltbnd_a_msf.geojson",
					...
					points : {
		                ...
		                name    : "CSIs au Niger",
		                // source (STRING) - Source of the layer's data.
		                source  : "data/ner_lvl1_hltbnd_p_msf.geojson",
	            ...
	            casesStyle : {
	                ...
	                titleForLegend : "Cases (by townships) TEST TEST",
			...
			context : [
				{
	                ...
	                name    : "Niger - Régions",
	                // source (STRING) - Source of the layer's data.
	                source  : "data/ner_lvl3_hltbnd_a_msf.geojson",
	                // format (STRING) - Set the format of the dataset.
	                format  : "GeoJSON",
		    ...
		    layout : {
		        ...
		        selectionDescription : "<i>Select a CSI using the drop-down list below or by clicking on the map.</i>",
		        // selectionDefault - Define default text for selector (displayed when no features are selected).
		        selectionDefault : "Select an CSI area...",
	        ...
	        chartsLayout : {
	            cumulative : {
	                title   : "Cumulative Incidence Rate (x 10000)",
	                legend  : "Cumulative Incidence Rate (x 10000)",
	                axis    : "Rates",
	                tooltip : "Cumulative Incidence rate"
	            },
	            measure : {
	            ...
	            combined : {
	                ...
	                line : {
	                    legend  : "Line : Cumulative cases",
	                    axis    : "Cumulative cases",
	                    tooltip : "cumulative cases"                    
	                }                
	            }
	        },
	};
